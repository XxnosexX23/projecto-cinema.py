...
axs[0].set_title('Ventas de productos')                             # Título del gráfico
axs[0].set_ylim(0, 200)                                             # Límite del eje y 

# Texto de ganancias en el primer gráfico
axs[0].text(
    1.05, 0.5, f"Ganancias:\n${total_sales}",                       # Texto a mostrar
    transform=axs[0].transAxes,                                     # Transformación de coordenadas  
...
axs[1].set_title('Elección de combos')                              # Título del gráfico
axs[1].set_ylim(0, 100)                                             # Límite del eje y
